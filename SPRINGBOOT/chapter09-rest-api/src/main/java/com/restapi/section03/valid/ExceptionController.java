...
public class ExceptionController {
    ...
    public ResponseEntity<ErrorResponse> methodValidException(MethodArgumentNotValidException e) {
        ...
        if(e.getBindingResult().hasErrors()) {
            detail = e.getBindingResult().getFieldError().getDefaultMessage(); // e.getMessage()와 같은 의미

            String bindResultCode = e.getBindingResult().getFieldError().getCode(); // Not Null, Size, NotBlank...
