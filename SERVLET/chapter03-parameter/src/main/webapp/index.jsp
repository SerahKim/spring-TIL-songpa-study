...
<body>
  ...
  <a href="querystring?name=김시은&age=33&birthday=2025-05-24&gender=F&national=jp&hobbies=movie&hobbies=music">쿼리스트링을 이용한 값 전달</a>

  <h4>form 태그를 이용한 post 방식</h4>
